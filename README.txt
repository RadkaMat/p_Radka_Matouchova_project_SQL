...
ve výsledku není rozlišováno, zda zaměstnanci pracují na plný pracovní úvazek, či ne !!!
...
3. První výzkumná otázka = v_radka_matouchova_project_SQL_first_question
   výpočet meziročního změna hodnoty mezd k jednotlivým odvětvím národního hospodářství
...
5. Třetí výzkumná otázka = v_radka_matouchova_project_SQL_third_question
   ...
   vybrání potraviny s nejmenším procentuálním meziročním nárůstem
